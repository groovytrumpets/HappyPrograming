                                            ...
                                            <div class="tab-pane active" id="edit-profile">
                                                ...
                                                <form class="edit-profile">
                                                    <div class="">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Job</label>
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                                <p class="font-weight-normal" style="margin-bottom: 0px">${requestScope.cvFound.jobProfession}</p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Introduction</label>
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Service</label>
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                                <p class="font-weight-normal" style="margin-bottom: 0px">${requestScope.cvFound.serviceDescription}</p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Achievement</label>
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                                <p class="font-weight-normal" style="margin-bottom: 0px">${requestScope.cvFound.experience}</p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Skills</label>
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                                <c:forEach items="${requestScope.skillMentor}" var="c">


                                                                    <label class="col-form-label">
                                                                        <p class="font-weight-normal" style="margin-bottom: 0px">${c.skillName}</p>
                                                                        <ul class="cours-star">
                            ...
                            <div class="item">
                                <div class="testimonial-bx">
                                    ...
                                    <div class="testimonial-info">
                                        <h5 class="name">Mentee: ${c.menteeId}</h5>
                                        <p>//rating star</p>
                                    </div>
