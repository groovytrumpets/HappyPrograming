<%-- 
    Document   : events
    Created on : 10 thg 10, 2024, 00:53:26
    Author     : ADMIN
--%>
                                ...
                                <div class="col-lg-8 col-md-7 col-sm-12">
                                    <div class="courses-post">
                                        <div class="ttr-post-media media-effect">
                                            <a href="#"><img src="https://cantho.fpt.edu.vn/Data/Sites/1/News/16399/333474194_540554358145815_6316924758580519094_n.jpg" alt=""></a>
                                        </div>
                                        <div class="ttr-post-info">
                                            <div class="ttr-post-title ">
                                                <h2 class="post-title">International Day - FPTU Ha Noi</h2>
                                            </div>
                                            <div class="ttr-post-text">
                                                <p>International Day is a cultural festival welcoming new students, held at FPT University Hanoi.</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-lg-5">
                                                <ul class="course-features">
                                                    <li><i class="ti-book"></i> <span class="label">Topics</span> <span class="value">Culture</span></li>
                                                    <li><i class="ti-help-alt"></i> <span class="label">Host</span> <span class="value">FPTU</span></li>
                                                    <li><i class="ti-time"></i> <span class="label">Location</span> <span class="value">Km29ĐLTL</span></li>
                                                    <li><i class="ti-stats-up"></i> <span class="label">Skill level</span> <span class="value">Beginner</span></li>
                                                    <li><i class="ti-smallcap"></i> <span class="label">Language</span> <span class="value">English</span></li>
                                                    <li><i class="ti-user"></i> <span class="label">Students</span> <span class="value">320+</span></li>
                                                </ul>
                                            </div>
                                            <div class="col-md-12 col-lg-7">
                                                ...
                                                <p>
                                                    <br>
                                                    ✅ Explore student clubs at FPT University Ha Noi
                                                    <br>✅ Check-in across borders from the UK, China, to Japan and South Korea
                                                   <br> ✅ Discover cultural exchanges between England, Japan, Korea, China, and Vietnam
                                                    <br>✅ Enjoy exciting performances
                                                    <br>✅ Participate in traditional games
                                                   <br> ✅ Visit the AI & IoT rooms, iMac lab, and cool bar
                                                    <br>✅ Enter a lucky draw to win prizes
                                                    <br>✅ Rock out with the music to your heart's content
...
<!--                                                <h5 class="m-b5">Event Content</h5>
                                ...
                                <div class="col-lg-4 col-md-5 col-sm-12 m-b30">
                                    ...
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1025.0539747174887!2d105.52474975159976!3d21.014696206320345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31345b4294f9b71f%3A0xa6159406faced446!2zVG_DoCBEZWx0YSAoxJDhuqFpIGjhu41jIEZQVCk!5e1!3m2!1svi!2s!4v1728245818892!5m2!1svi!2s" class="align-self-stretch d-flex" style="width:100%; min-width:100%; min-height:400px;" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
